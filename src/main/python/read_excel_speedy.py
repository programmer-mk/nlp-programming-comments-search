...
data_frame = data_frame.reindex(['ProgrammingLanguageName', 'RepoDescription', 'SourceDescription', 'PairID', 'CommentText'], axis=1)
data_frame.to_csv(f'{resources_directory}/output_no_similarity_score.txt', sep = '\t', index = False, columns=['ProgrammingLanguageName','RepoDescription',
                                                                                                'SourceDescription','PairID', 'CommentText'])

data_frame_similarity_score = pd.DataFrame(columns=['ProgrammingLanguageName', 'QueryId', 'PairID', 'QueryText', 'CommentText','SimilarityScore'])
dict_query_line = {}
